...
SYSTEM_PROMPT_RULES = (
    ...
    "- STOK \"Habis\" -> tawarkan opsi lain.\n"
    "- STOK \"Terbatas\" -> informasikan stok terbatas, sarankan segera order.\n"
    "- STOK \"Tersedia\" -> tidak perlu sebut stok secara eksplisit kecuali ditanya.\n"
    "- DILARANG sebut angka stok persis. Gunakan label Habis/Terbatas/Tersedia saja.\n"
